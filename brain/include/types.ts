...
export interface BrainFrame { version:1; tick:number; model_tick?:number; activity:Uint8Array; active_neuron_count:number; sensory_values:Float32Array; motor_values:Float32Array; }
