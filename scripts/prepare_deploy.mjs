...
for(const name of ['index.html','wasm/sim.wasm','connectome/manifest.json','connectome-graph/catalog.json'])if(!fs.existsSync(new URL(name,source)))throw Error('Build missing '+name);
